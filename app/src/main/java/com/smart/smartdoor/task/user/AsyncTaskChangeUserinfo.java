...
import com.smart.smartdoor.dto.request.ChangeUserinfoRequest;
...
public class AsyncTaskChangeUserinfo extends AsyncTask<Void, Void, String> {
    ...
    public AsyncTaskChangeUserinfo(Context context, String cid, String name, String password, String gender, String birthday, String citizenNumber, Runnable runnable) {
    ...
    protected String doInBackground(Void... result) {
        try {
            ChangeUserinfoRequest request = new ChangeUserinfoRequest(cid, name, Global.hashString(password), gender, birthday, citizenNumber);

            String urlAddress = NetworkUtils.baseUrl + "/" + NetworkUtils.urlChangeUserinfo;
            ...
            User.instance.gender = gender;
            User.instance.birthday = birthday;
            User.instance.citizenNumber = citizenNumber;
