...
import com.smart.smartdoor.dto.request.CheckRegisterRequest;
...
public class AsyncTaskCheckRegister extends AsyncTask<Void, Void, String> {
    ...
    public AsyncTaskCheckRegister(Context context, String cId, Runnable runnable) {
    ...
    protected String doInBackground(Void... result) {
        try {
            CheckRegisterRequest request = new CheckRegisterRequest(cId);

            String urlAddress = NetworkUtils.baseUrl + "/" + NetworkUtils.urlCheckRegister;
