...
package com.smart.smartdoor.utils.uilib.alerts.dialog.utils;
...
public class SDialogUtils {
    ...
    public void backgroundColor(@NonNull View view, int color) {
        ...
        RippleDrawable rippleDrawable = new RippleDrawable(ColorStateList.valueOf(color), gradientDrawable, null);
    ...
    /**
     * Create the progress drawable for {@link com.smart.smartdoor.utils.uilib.alerts.dialog.ProgressSDialog}.
    ...
    public Drawable createProgressLayerList(int progressColor, int backgroundColor) {
        int cornerRadius = dp(6);

        RoundRectShape backgroundShape = new RoundRectShape(
                new float[]{
                        cornerRadius,
                        cornerRadius,
                        cornerRadius,
        ...
        RoundRectShape progressShape = new RoundRectShape(
                new float[]{
                        cornerRadius,
                        cornerRadius,
                        cornerRadius,
        ...
        ShapeDrawable progressDrawable = new ShapeDrawable(progressShape);
