...
package com.smart.smartdoor.utils.uilib.alerts.dialog;
...
import com.smart.smartdoor.utils.uilib.alerts.dialog.callbacks.OnDismissCallback;
import com.smart.smartdoor.utils.uilib.alerts.dialog.utils.SDialogUtils;
import com.smart.smartdoor.utils.uilib.sdialog.recyclerview.SRecyclerView;
import com.smart.smartdoor.utils.uilib.sdialog.scroll.SScrollView;
...
public class SDialog {
    ...
    protected void updateTheme() {
        switch (theme) {
            case SDialogUtils.THEME_BY_SYSTEM:
                ...
                break;
            case SDialogUtils.THEME_DARK:
                darkThemeColors();
                break;
            case SDialogUtils.THEME_LIGHT:
                lightThemeColors();
                break;
        }
    }

    public void updateCorner(int color) {
        utils.backgroundColor(b.main, color);
    }
    ...
    protected static class DialogBinding {
        ...
        final TextView title, text, positive, negative, neutral;
        final SRecyclerView recycler;
