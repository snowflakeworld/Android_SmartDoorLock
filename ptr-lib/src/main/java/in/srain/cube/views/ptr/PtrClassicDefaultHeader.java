...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private boolean mShouldShowLastUpdateFlag = true;
     ...
     * @param enable
     */
    public void setShowLastUpdateTime(boolean enable) {
        mShouldShowLastUpdateFlag= enable;
    }
    ...
    public void onUIReset(PtrFrameLayout frame) {
        resetView();
        mShouldShowLastUpdate = mShouldShowLastUpdateFlag && true;
